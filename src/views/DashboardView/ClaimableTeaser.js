...
const PrimaryBackgroundContainer = tw.div`-mx-8 px-8 bg-primary-900 text-gray-100 -mt-8 mb-4`;
const SubHeader = tw(Subheading)`text-center text-gray-500 mb-4`;
export default function ClaimableTeaser({amount, owner}) {
    ...
    if (amount > 0.1) {
        return <PrimaryBackgroundContainer>
            <Center>
                ...
                <SubHeader>You've got unclaimed yields waiting for you. <br/>You can claim them straight from this app!</SubHeader>
                <PrimaryButton onClick={() => {
                    history.push(`/${owner}/claimables`)
                }
