                    ...
                    <Transaction>
                        <a target={"_blank"} href={`${transaction.network.baseUrl}/tx/${transaction.hash}`}>
                            <AccountLink>
                                ...
                                <div tw="w-8 h-8 rounded-full mr-2 ">
                                    <FallbackImage src={transaction.network.logo}/>
                                </div>
                                Transaction <div
                                tw="bg-gray-300 mx-2 px-2 py-1 rounded flex items-center"> {sliceAccount(transaction.hash)}

                                <div tw="bg-white p-1 mx-1 rounded-lg">
